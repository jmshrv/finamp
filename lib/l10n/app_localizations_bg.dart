...
class AppLocalizationsBg extends AppLocalizations {
  ...
  @override
  String get startMixNoTracksArtist => 'Натиснете и задръжте върху изпълнител, за да го добавите или премахнете, от разбъркано възпроизвеждане';

  @override
  String get startMixNoTracksAlbum => 'Натиснете и задръжте върху албум, за да го добавите или премахнете от разбъркано възпроизвеждане';
  ...
  @override
  String get failedToGetTrackFromDownloadId => 'Неуспех при получаване на песен, посредством ID на изтегляне';
  ...
  @override
  String get downloadsQueued => 'Добавено в изтегляния.';
  ...
  String applicationLegalese(String sourceCodeLink) {
    return 'Лиценз Mozilla Public License 2.0. Програмният код е достъпен на:\n\ngithub.com/jmshrv/finamp';
  }
  ...
  @override
  String get downloadedTracksWillNotBeDeleted => 'Изтеглените песни няма да бъдат изтрити';
  ...
  @override
  String get shuffleAllTrackCount => 'Разбъркайте всички песни';

  @override
  String get shuffleAllTrackCountSubtitle => 'Брой песни за зареждане при използване на бутона за разбъркване на всички песни.';
  ...
  @override
  String get useCoverAsBackground => 'Показване на замъглена обложка като фон на плейъра';

  @override
  String get useCoverAsBackgroundSubtitle => 'Дали да се показва или не, замъглена обложка на албума като фон на плейъра.';
  ...
  @override
  String get hideTrackArtistsIfSameAsAlbumArtists => 'Скриване изпълнителя на песента, ако е същият като изпълнителя на албума';

  @override
  String get hideTrackArtistsIfSameAsAlbumArtistsSubtitle => 'Дали да се покаже изпълнителят на песента на екрана, ако не се различава от изпълнителя на албума.';
