...
class AppLocalizationsCa extends AppLocalizations {
  ...
  String get finampTagline =>
      'Un reproductor de música de codi obert per a Jellyfin';
  ...
  String get aboutContributionPrompt =>
      'Feta per gent meravellosa en el seu temps lliure.\nTu podries ser un d\'ells!';
  ...
  String get loginFlowQuickConnectInstructions =>
      'Obriu l\'aplicació o el web de Jellyfin, feu clic sobre la icona del vostre usuari i seleccioni «Connexió ràpida».';

  @override
  String get loginFlowQuickConnectDisabled =>
      'Quick Connect es troba deshabilitat en aquest servidor.';
  ...
  String get usernameValidationMissingUsername =>
      'Si us plau, introdueix el teu nom d\'usuari';
  ...
  String get startMixNoTracksArtist =>
      'Prém sostingudament per afegir o eliminar un artista de la llista de cançons abans de començar la llista';

  @override
  String get startMixNoTracksAlbum =>
      'Manté pres un àlbum per afegir o esborrar-lo del creador de barreges abans de començar una barreja';

  @override
  String get startMixNoTracksGenre =>
      'Manté pres un gènere per afegir o esborrar-lo del creador de barreges abans de començar una barreja';
  ...
  String get syncDownloadedPlaylists =>
      'Sincronitza les llistes de reproducció descarregades';
  ...
  String get errorScreenError =>
      'Un error ha succeït mentre s\'intentava obtenir la llista d\'errors! En aquest punt, probablement hauries de crear una sol·licitud a GitHub i esborrar les dades de l\'aplicació';

  @override
  String get failedToGetTrackFromDownloadId =>
      'Error a l\'hora de trobar-lo pel seu ID de descàrrega';
  ...
  String get editPlaylistNameTooltip =>
      'Edita el nom de la llista de reproducció';
  ...
  @override
  String get playlistUpdated => 'Nom de la llista de reproducció actualitzat.';
  ...
  String get notAvailableInOfflineMode =>
      'No disponible en mode sense connexió';
  ...
  String get downloadedTracksWillNotBeDeleted =>
      'Les pistes descarregades no s\'esborraran';
  ...
  String get enableTranscodingSubtitle =>
      'Codifica la música en el costat del servidor.';
  ...
  String get bitrateSubtitle =>
      'Una taxa de bits més alta dona una millor qualitat d\'àudio a canvi d\'una major amplada de banda.';
  ...
  String get pathReturnSlashErrorMessage =>
      'Rutes que retornen \"/\" no poden ser utilitzades';
  ...
  String get customLocationsBuggy =>
      'Ubicacions personalitzades poden ser extremadament inestables i no són recomanables en la majoria dels casos. Les ubicacions sota el sistema de carpeta \'Music\' prevenen la portada de l\'àlbum de poder guardar-se per limitacions del SO.';

  @override
  String get enterLowPriorityStateOnPause =>
      'Introdueix un Estat de Baixa Prioritat en la Pausa';

  @override
  String get enterLowPriorityStateOnPauseSubtitle =>
      'Permet que la notificació sigui descartable quan estigui pausat. A més, permet a Android parar el servei quan està pausat.';
  ...
  String get shuffleAllTrackCountSubtitle =>
      'Quantitat de cançons que es carreguen quan s\'utilitza el botó barrejador de cançons.';
  ...
  String get playbackSpeedControlSetting =>
      'Visualització de la Velocitat de Reproducció';

  @override
  String get playbackSpeedControlSettingSubtitle =>
      'Si es mostren els controls de velocitat de reproducció al menú de la pantalla del reproductor';
  ...
  String get showTextOnGridViewSubtitle =>
      'Mostrar el text (títol, artista, etc.) a la pantalla de música en graella.';

  @override
  String get useCoverAsBackground =>
      'Utilitza una cobertura difuminada pel fons de pantalla';

  @override
  String get useCoverAsBackgroundSubtitle =>
      'Utilitzar una portada d\'àlbum difuminada com a fons de pantalla en diferents apartats de l\'aplicació.';

  @override
  String get playerScreenMinimumCoverPaddingEditorTitle =>
      'Marge interior mínim per l\'àlbum';

  @override
  String get playerScreenMinimumCoverPaddingEditorSubtitle =>
      'Marge interior mínim al voltant de la portada de l\'àlbum en la pantalla del reproductor, en % en l\'amplada de la pantalla.';

  @override
  String get hideTrackArtistsIfSameAsAlbumArtists =>
      'Amaga els artistes de la cançó si són els mateixos que els de l\'àlbum';

  @override
  String get hideTrackArtistsIfSameAsAlbumArtistsSubtitle =>
      'Amaga als artistes de les cançons en la pantalla de l\'àlbum si no difereixen dels de l\'àlbum.';
  ...
  String get addToMorePlaylistsTooltip =>
      'Afageix a més llistes de reproducció';
  ...
  String get removeFromPlaylistTooltip =>
      'Elimina d\'aquesta llista de reproducció';

  @override
  String get removeFromPlaylistTitle =>
      'Eliminar d\'aquesta llista de reproducció';
  ...
  String get playlistActionsMenuButtonTooltip =>
      'Toca per afegir a la llista de reproducció. Premer sostingut per afegir un favorit.';
  ...
  String get bufferDurationSubtitle =>
      'La durada màxima que s\'ha d\'amortitzar, en segons. Requereix reiniciar.';

  @override
  String get bufferDisableSizeConstraintsTitle =>
      'No limitar la mida de la memòria intermèdia';

  @override
  String get bufferDisableSizeConstraintsSubtitle =>
      'Desactiva les restriccions de mida de la memòria intermèdia (\'Mida del cursor\'). La memòria intermèdia sempre es carregarà a la durada configurada (\'Duració de la memòria intermèdia\'), fins i tot per a fitxers molt grans. Pot causar fallades. Requereix reiniciar.';
  ...
  String get bufferSizeSubtitle =>
      'Mida màxima de la memòria intermèdia en MB. Requereix reiniciar';
  ...
  String get skipToPreviousTrackButtonTooltip =>
      'Salta cap al principi o cap a la cançó prèvia';
  ...
  String get playbackOrderLinearButtonTooltip =>
      'Reproduint en ordre. Clica per barrejar.';
  ...
  String get playbackOrderShuffledButtonTooltip =>
      'Barrejant pistes. Clica per reproduir en ordre.';
