...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get startupErrorTitle => '应用启动时出错了！\n很抱歉……';

  @override
  String get startupErrorCallToAction =>
      '请在 github.com/jmshrv/finamp 上创建一个问题，并附上日志（！）（使用下面的按钮）和此页面的屏幕截图，以便我们尽快修复它。';

  @override
  String get startupErrorWorkaround =>
      '解决方法是，您可以清除应用数据来重置应用。请注意，此操作会导致您的所有设置和下载内容被删除。';
  ...
  @override
  String get appearsOnAlbums => '出现在';
  ...
  @override
  String get performingArtists => '表演艺术家';
  ...
  @override
  String get libraryDownloads => '媒体库下载';
  ...
  @override
  String get playlistUpdated => '播放列表名称已更新。';
  ...
  @override
  String get playbackReporting => '播放报告';
  ...
  @override
  String get bitrateSubtitle => '更高的比特率可以提供更高质量的音频，但需要更高的带宽。不适用于无损编解码器，例如 FLAC';
  ...
  @override
  String get autoSwitchItemCurationTypeTitle => '自动切换项目管理类型';

  @override
  String get autoSwitchItemCurationTypeSubtitle =>
      '启用后，如果没有可用的项目（例如，没有特定艺术家的收藏），艺术家和流派屏幕上的项目部分将自动切换到不同的项目类型。';

  @override
  String get showArtistsTracksSection => '显示歌曲部分';

  @override
  String get showArtistsTracksSectionSubtitle =>
      '是否显示最多包含五首歌曲的版块。启用后，您可以在“最常播放”、“收藏”、“随机”、“最新发布”和“最近添加的曲目”之间进行选择。';
  ...
  @override
  String get stopAndClearQueue => '停止播放并清除队列';
  ...
  String get reportQueueToServerSubtitle =>
      '启用后，Finamp 会将当前队列发送到服务器。这可以改善远程控制，并允许服务器端恢复队列。如果启用了“继续播放”功能，则始终启用。';
  ...
  @override
  String get playOnStaleDelay => '“继续播放”会话超时';

  @override
  String get playOnStaleDelaySubtitle =>
      '远程“继续播放”会话在收到命令后多久被视为处于活动状态。当被视为处于活动状态时，播放报告会更频繁，这可能会导致带宽使用量增加。';

  @override
  String get enablePlayonTitle => '启用“继续播放”支持';

  @override
  String get enablePlayonSubtitle =>
      '启用 Jellyfin 的“继续播放”功能（从其他客户端远程控制 Finamp）。如果您的反向代理或服务器不支持 websockets，请禁用此功能。';

  @override
  String get playOnReconnectionDelay => '“继续播放”会话重新连接延迟';

  @override
  String get playOnReconnectionDelaySubtitle =>
      '控制 继续播放 websocket 断开连接后重新连接尝试的延迟时间（以秒为单位）。延迟越低，带宽使用量就越大。';
  ...
  @override
  String get latestTracks => '最新歌曲';

  @override
  String get latestAlbums => '最新专辑';

  @override
  String get latestArtists => '最新艺术家';
  ...
  @override
  String get favoriteTracks => '收藏的歌曲';

  @override
  String get favoriteAlbums => '收藏的专辑';

  @override
  String get favoriteArtists => '收藏的艺术家';

  @override
  String get randomTracks => '歌曲（随机选择）';

  @override
  String get randomAlbums => '专辑（随机选择）';

  @override
  String get randomArtists => '艺术家（随机选择）';

  @override
  String get mostPlayed => '最常播放';

  @override
  String get randomFavoritesFirst => '随机（收藏优先）';
  ...
  @override
  String get latestReleases => '最新发布';

  @override
  String get itemSectionsOrder => '项目部分顺序';

  @override
  String get unknown => 'Unknown';

  @override
  String get itemSectionsOrderSubtitle => '控制项目部分的顺序。';

  @override
  String get genreItemSectionFilterChipOrderTitle => '项目部分筛选顺序';

  @override
  String get genreItemSectionFilterChipOrderSubtitle => '控制项目部分筛选器的顺序。';

  @override
  String get artistItemSectionFilterChipOrderTitle => '歌曲部分筛选器顺序';

  @override
  String get artistItemSectionFilterChipOrderSubtitle => '控制歌曲部分可用筛选器的顺序。';

  @override
  String get genreFilterArtistScreens => '筛选艺术家屏幕';

  @override
  String get genreFilterArtistScreensSubtitle =>
      '启用后，艺术家屏幕（通过流派访问）将仅显示与您当前浏览的流派匹配的歌曲和专辑。（您可以随时手动移除流派筛选器以显示所有歌曲和专辑。）';
  ...
  @override
  String get genreListsInheritSorting => '完整列表排序继承';
  ...
  @override
  String get playbackReportingSettingsTitle => '播放报告和播放继续';
  ...
  @override
  String get swipeLeftToRightAction => '向右轻扫操作';

  @override
  String get swipeLeftToRightActionSubtitle => '从左到右滑动列表中的歌曲时触发的动作.';

  @override
  String get swipeRightToLeftAction => '向左轻扫操作';

  @override
  String get swipeRightToLeftActionSubtitle => '从右向左滑动列表中的音轨时触发的动作.';
  ...
  @override
  String get transcodingStreamingFormatTitle => '选择转码格式';

  @override
  String get transcodingStreamingFormatSubtitle =>
      '选择串流转码音频时要使用的格式.已排队的音轨不会受到影响.';
  ...
  @override
  String get oneLineMarqueeTextButtonSubtitle => '自动滚动太长而无法在两行中显示的歌曲标题';
  ...
  @override
  String get lyricsScreenButtonTitle => '歌词';
  ...
  String get showStopButtonOnMediaNotificationSubtitle =>
      '控制媒体通知是否包含停止按钮。这样无需打开应用即可停止播放。';

  @override
  String get showShuffleButtonOnMediaNotificationTitle => '在媒体通知上显示随机播放按钮';

  @override
  String get showShuffleButtonOnMediaNotificationSubtitle =>
      '控制媒体通知是否包含随机播放按钮。这样，您无需打开应用即可随机/取消随机播放。';

  @override
  String get showFavoriteButtonOnMediaNotificationTitle => '在媒体通知上显示收藏按钮';

  @override
  String get showFavoriteButtonOnMediaNotificationSubtitle =>
      '控制媒体通知是否包含收藏按钮。这样，您无需打开应用即可收藏/取消收藏当前歌曲。';

  @override
  String get showSeekControlsOnMediaNotificationTitle => '允许在媒体通知中搜索';
  ...
  @override
  String get autoOfflineOptionOff => '已禁用';

  @override
  String get autoOfflineOptionNetwork => '本地网络';

  @override
  String get autoOfflineOptionDisconnected => '断开';

  @override
  String get autoOfflineSettingDescription =>
      '自动启用脱机模式.\n已禁用:不会自动开启离线模式,可节省电池.\n本地网络: 在未连接到wifi或以太网时打开脱机模式.\n断开连接: 在未连接任何设备时打开脱机模式.\n您可以随时手动开启离线模式,它会暂停自动化,直到您再次关闭离线模式';

  @override
  String get autoOfflineSettingTitle => '自动离线模式';
  ...
  String autoOfflineNotification(String state) {
    ...
    return '自动 $_temp0 离线模式';
  }

  @override
  String get audioFadeOutDurationSettingTitle => '音频淡出持续时间';

  @override
  String get audioFadeOutDurationSettingSubtitle => '音频淡出的持续时间（以毫秒为单位）。';

  @override
  String get audioFadeInDurationSettingTitle => '音频淡入持续时间';

  @override
  String get audioFadeInDurationSettingSubtitle =>
      '音频淡入的持续时间（以毫秒为单位）。设置为 0 可禁用淡入。';

  @override
  String get outputMenuButtonTitle => '输出';

  @override
  String get outputMenuTitle => '更改输出';

  @override
  String get outputMenuVolumeSectionTitle => '音量';

  @override
  String get outputMenuDevicesSectionTitle => '可用设备';

  @override
  String get outputMenuOpenConnectionSettingsButtonTitle => '连接到设备';
  ...
  @override
  String get desktopShuffleWarning => '随机播放目前在桌面版不可用';

  @override
  String get preferHomeNetworkActiveAddressInfoText => '活动地址';

  @override
  String get preferHomeNetworkTargetAddressLocalSettingTitle => '家庭网络地址';

  @override
  String get preferHomeNetworkTargetAddressLocalSettingDescription =>
      '家庭网络内的 Jellyfin 服务器的目标地址';

  @override
  String get preferHomeNetworkEnableSwitchTitle => '首选家庭网络';

  @override
  String get preferHomeNetworkEnableSwitchDescription => '在家时是否使用其他地址';
  ...
  String get preferHomeNetworkPublicAddressSettingDescription =>
      '用于连接 Jellyfin 服务器的主要地址';

  @override
  String get preferHomeNetworkInfoBox => '此功能需要位置权限（并且需要启用位置）才能读取网络名称。';

  @override
  String get networkSettingsTitle => '网络';

  @override
  String get downloadPaused => '由于设备未连接到 WiFi，下载暂停';

  @override
  String get missingSchemaError => 'Url 需要以 http(s):// 开头';

  @override
  String get testConnectionButtonLabel => '测试两个连接';
  ...
  @override
  String get autoReloadQueueTitle => '自动重新加载队列';

  @override
  String get autoReloadQueueSubtitle =>
      '当源更改（例如启用离线模式或切换服务器地址）时自动重新加载队列。如果禁用，Finamp 将提示您。';
  ...
  String autoReloadPromptMissingTracks(int amountUndownloadedTracks) {
    return '$amountUndownloadedTracks 将从队列中删除，因为它们尚未下载。';
  }

  @override
  String get autoReloadPromptReloadButton => '重新加载';
}
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get startupErrorTitle => '啟動時發生了一些錯誤!\n不好意思...';

  @override
  String get startupErrorCallToAction =>
      '請在網站 github.com/jmshrv/finamp 提交問題描述並附上程式日誌檔(!) (可使用下方按鈕) 以及現在畫面的截圖, 以讓我們盡快修正此問題.';

  @override
  String get startupErrorWorkaround =>
      '一種可行的修復方式是清除程式的資料以進行重設. 注意到這也會同時清除你現在的設定以及之前下載的內容.';
  ...
  @override
  String get appearsOnAlbums => '出現在';
  ...
  @override
  String get performingArtists => '出演藝人';
  ...
  @override
  String get libraryDownloads => '媒體庫下載';
  ...
  @override
  String get playlistUpdated => '播放清單名稱已更新。';
  ...
  @override
  String get exportLogs => '儲存程式日誌檔案';
  ...
  @override
  String get playbackReporting => '播放分析';
  ...
  String get bitrateSubtitle =>
      '更高的位元速率可提升音訊品質，但也會消耗更多的頻寬。此設定不適用於無損壓縮編碼，例如 FLAC';
  ...
  @override
  String get reportQueueToServerSubtitle =>
      '啟用後，Finamp 會將當前播放佇列回報至 Jellyfin 伺服器。這可以改善遙控並允許伺服端恢復播放隊列。「播放在」功能啟用時將永遠啟用。';
  ...
  @override
  String get playOnStaleDelay => '「播放在」工作階段逾時時間';

  @override
  String get playOnStaleDelaySubtitle =>
      '遠端「播放在」工作階段在收到指令後認為活躍的時間。當認為活躍時，播放進度會更頻繁的回報，因而可能造成更大的頻寬消耗。';

  @override
  String get enablePlayonTitle => '啟用「播放在」支援';

  @override
  String get enablePlayonSubtitle =>
      '啟用 Jellyfin 的「播放在」功能（從其他用戶端遠端控制 Finamp）。如果你的伺服器或反向代理不支援 websockets，請關閉此選項。';

  @override
  String get playOnReconnectionDelay => '「播放在」工作階段重新連線延遲';

  @override
  String get playOnReconnectionDelaySubtitle =>
      '控制當「播放在」的 websocket 連線中斷時嘗試重新連線的間隔（秒）。較短的延遲可能導致更高的網路流量。';
  ...
  @override
  String get playbackReportingSettingsTitle => '播放分析、播放在';
  ...
  @override
  String get swipeLeftToRightAction => '右滑動作';

  @override
  String get swipeLeftToRightActionSubtitle => '在音軌清單中將音軌由左往右滑時觸發的動作。';

  @override
  String get swipeRightToLeftAction => '左滑動作';

  @override
  String get swipeRightToLeftActionSubtitle => '在音軌清單中將音軌由右往左滑時觸發的動作。';
  ...
  @override
  String get transcodingStreamingFormatTitle => '選擇轉檔格式';

  @override
  String get transcodingStreamingFormatSubtitle =>
      '選擇串流轉檔使用的格式。已經加入播放隊列的歌曲不會受到影響。';
  ...
  @override
  String get lyricsScreenButtonTitle => '歌詞';
  ...
  @override
  String get autoOfflineOptionOff => '停用';

  @override
  String get autoOfflineOptionNetwork => '區域網路';

  @override
  String get autoOfflineOptionDisconnected => '離線';

  @override
  String get autoOfflineSettingDescription =>
      '自動啟用離線模式。\n停用：不會自動啟用離線模式。可能可以節省電力。\n區域網路：離開 Wifi 或乙太網路連線時啟用離線模式。\n離線：失去網路連線時啟用離線模式。\n你可以手動啟用離線模式，這麼做將會暫停自動離線模式，直到離線模式被手動關閉';

  @override
  String get autoOfflineSettingTitle => '自動離線模式';
  ...
  String autoOfflineNotification(String state) {
    ...
    return '自動 $_temp0 離線模式';
  }

  @override
  String get audioFadeOutDurationSettingTitle => '音訊淡出時長';

  @override
  String get audioFadeOutDurationSettingSubtitle => '音訊淡出的時間長度，以毫秒為單位。';

  @override
  String get audioFadeInDurationSettingTitle => '音訊淡入時長';

  @override
  String get audioFadeInDurationSettingSubtitle =>
      '音訊淡入的時間長度，以毫秒為單位。設為 0 以停用音訊淡入。';

  @override
  String get outputMenuButtonTitle => '輸出';

  @override
  String get outputMenuTitle => '更改輸出';

  @override
  String get outputMenuVolumeSectionTitle => '音量';

  @override
  String get outputMenuDevicesSectionTitle => '可用的裝置';

  @override
  String get outputMenuOpenConnectionSettingsButtonTitle => '連線至裝置';
  ...
  @override
  String get desktopShuffleWarning => '隨機播放目前在桌面版不可用。';
}
...
class AppLocalizationsZhHantHk extends AppLocalizationsZh {
  ...
  @override
  String get finampTagline => '一個為 Jellyfin 而設的開源音樂播放器';

  @override
  String get startupErrorTitle => '啟動應用程式時出現錯誤！';

  @override
  String get startupErrorCallToAction =>
      '請在 github.com/jmshrv/finamp 上提交錯誤報告並附上程式記錄(!) （可使用下方按鈕）及截圖，讓我們能為你更快修正問題。';

  @override
  String get startupErrorWorkaround =>
      '你可嘗試透過清除資料來重設應用程式，但重設後，所有設定及已下載的檔案將會被刪除。';

  @override
  String get about => '關於 Finamp';

  @override
  String get aboutContributionPrompt => '由一班慷慨的人在空閒的時間開發而成。\n你也可以成為其中一份子！';

  @override
  String get aboutContributionLink => '在 GitHub 上參與 Finamp 的開發：';

  @override
  String get aboutReleaseNotes => '瀏覽最新版本的說明：';

  @override
  String get aboutTranslations => '協助翻譯 Finamp：';
  ...
  @override
  String get loginFlowSlogan => '音樂，隨心所欲。';

  @override
  String get loginFlowGetStarted => '開始使用！';

  @override
  String get viewLogs => '檢視程式記錄';

  @override
  String get changeLanguage => '更改語言';

  @override
  String get loginFlowServerSelectionHeading => '連接至 Jellyfin';
  ...
  @override
  String get internalExternalIpExplanation =>
      '如果您需要在局部區域網絡（LAN）以外的地方連接 Jellyfin，請使用伺服器的區域網絡（WAN）IP。\n\n如果目標伺服器使用的連接埠（port）是 HTTP 的預設連接埠（80／433），則毋須填寫連接埠。\n\n如果 URL 輸入正確，伺服器的資訊將會在下方的輸入欄位顯示。';

  @override
  String get serverUrlHint => '例如：demo.jellyfin.org/stable';

  @override
  String get serverUrlInfoButtonTooltip => '伺服器 URL 說明';

  @override
  String get emptyServerUrl => '伺服器 URL 並不能漏空';

  @override
  String get connectingToServer => '正在連接伺服器…';

  @override
  String get loginFlowLocalNetworkServers => '在區域網路上的伺服器：';

  @override
  String get loginFlowLocalNetworkServersScanningForServers => '正在搜尋伺服器…';

  @override
  String get loginFlowAccountSelectionHeading => '選擇您的帳號';

  @override
  String get backToServerSelection => '返回伺服器揀選';

  @override
  String get loginFlowNamelessUser => '無名氏';

  @override
  String get loginFlowCustomUser => '自訂用戶';

  @override
  String get loginFlowAuthenticationHeading => '登入';

  @override
  String get backToAccountSelection => '返回至帳號揀選';

  @override
  String get loginFlowQuickConnectPrompt => '使用 Quick Connect 代碼';

  @override
  String get loginFlowQuickConnectInstructions =>
      '打開 Jellyfin 應用程式或網頁，然後點擊用戶圖示，再選擇 Quick Connect。';

  @override
  String get loginFlowQuickConnectDisabled => '伺服器停用了 Quick Connect 功能。';

  @override
  String get orDivider => '或';

  @override
  String get loginFlowSelectAUser => '揀選用戶';

  @override
  String get username => '用戶名稱';

  @override
  String get usernameHint => '輸入您的用戶名稱';

  @override
  String get usernameValidationMissingUsername => '用戶名稱不能漏空';

  @override
  String get password => '密碼';

  @override
  String get passwordHint => '請輸入你的密碼';
  ...
  @override
  String get startMixNoTracksGenre => '在開始混音之前，長按曲風以添加至混音器或從混音器移除';
  ...
  @override
  String get albumArtists => '專輯歌手';

  @override
  String get performingArtists => '參演歌手';
  ...
  @override
  String get activeDownloads => '正在下載';
  ...
  @override
  String get noActiveDownloads => '無正下載的項目。';
  ...
  String deleteDownloadsPrompt(String itemName, String itemType) {
    ...
    return '你確定要刪除 $_temp0 \'$itemName\' 嗎？';
  }
  ...
  @override
  String get noItemsDownloaded => '沒有任何項目。';
  ...
  @override
  String get playlistUpdated => '已更新播放清單名稱。';
  ...
  @override
  String get confirmDownloadStarted => '已開始下載';

  @override
  String get downloadsQueued => '開始下載檔案。';

  @override
  String get addButtonLabel => '加入';

  @override
  String get shareLogs => '分享所有記錄檔';

  @override
  String get exportLogs => '儲存記錄檔';

  @override
  String get logsCopied => '已複製所有記錄。';
  ...
  @override
  String applicationLegalese(String sourceCodeLink) {
    return '採用 Mozilla Public License 2.0 特許條款。\n原始碼：$sourceCodeLink。';
  }
  ...
  @override
  String get bitrateSubtitle => '越高的位元速率帶來越好的音質，但亦會使用更多的流量。不會套用至無損格式，例如 FLAC。';
  ...
  @override
  String get customLocationsBuggy =>
      '自訂位置功能並不保證可正常運作。如非必要，建議不要使用。使用系統的「音樂」資料夾會因權限問題而令專輯封面圖無法儲存。';

  @override
  String get enterLowPriorityStateOnPause => '暫停播放時進入「低優先」狀態';

  @override
  String get enterLowPriorityStateOnPauseSubtitle =>
      '停止播放時，允許本程式的「通知」能被掃走及關閉應用程式（適用於 Android 裝置）。';

  @override
  String get shuffleAllTrackCount => '隨機播放上限';

  @override
  String get shuffleAllTrackCountSubtitle => '隨機播放的歌曲數量上限。';
  ...
  @override
  String get customizationSettingsTitle => '自訂';

  @override
  String get playbackSpeedControlSetting => '速度控制顯示';

  @override
  String get playbackSpeedControlSettingSubtitle => '播放速度控制是否顯示在播放介面的選單中';
