...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get finampTagline =>
      'Un reproductor de música de código abierto para Jellyfin';
  ...
  String get aboutContributionPrompt =>
      'Creado por gente increíble en su tiempo libre.\nTu podrías ser uno de ellos!';

  @override
  String get aboutContributionLink =>
      'Contribuye al repositorio de Finamp en GitHub:';
  ...
  String get internalExternalIpExplanation =>
      'Si quieres acceder a tu servidor Jellyfin remotamente, tendrás que usar tu dirección IP externa.\n\nSi tu servidor está en un puerto HTTP (80/443) o en el puerto predeterminado de Jellyfin (8096), no tienes que especificar el puerto.\n\nSi la dirección es correcta, podrás ver algunos datos sobre tu servidor en el formulario.';
  ...
  String get loginFlowQuickConnectPrompt =>
      'Usar código de Inicio de Sesión Rápido';

  @override
  String get loginFlowQuickConnectInstructions =>
      'Abre la aplicación o la página web de Jellyfin, haz clic en el icono de tu usuario, y selecciona Conexión Rápida.';

  @override
  String get loginFlowQuickConnectDisabled =>
      'La Conexión Rápida esta deshabilitada en este servidor.';
  ...
  @override
  String get appearsOnAlbums => 'Aparece en';
  ...
  String get startMixNoTracksGenre =>
      'Mantén pulsado un género para añadirlo o eliminarlo del mezclador antes de empezar una mezcla';
  ...
  @override
  String get performingArtists => 'Artistas intérpretes';
  ...
  @override
  String get libraryDownloads => 'Descargas de la biblioteca';
  ...
  @override
  String get playlistUpdated => 'Se actualizó el nombre de la lista.';
  ...
  String get bitrateSubtitle =>
      'Una tasa de bits más alta da una mayor calidad de audio a costa de un mayor ancho de banda. No aplica a códecs de audio sin pérdida, p. ej. FLAC';
  ...
  String get pathReturnSlashErrorMessage =>
      'No se pueden utilizar ubicaciones que devuelvan \"/\"';
  ...
  String get customLocationsBuggy =>
      'Las ubicaciones personalizadas pueden ser extremadamente problemáticas, y no son recomendadas para la mayoría de usos. Ubicaciones dentro de la carpeta del sistema \"Música\" podría impedir que las imágenes de los álbumes se guarden debido a limitaciones del sistema operativo.';
  ...
  String get playbackSpeedControlSetting =>
      'Visibilidad de la Velocidad de Reproducción';

  @override
  String get playbackSpeedControlSettingSubtitle =>
      'Habilita o deshabilita que los controles de velocidad de reproducción se muestren en el menú de la pantalla del reproductor';
  ...
  String get playerScreenMinimumCoverPaddingEditorTitle =>
      'Margen mínimo en la portada del álbum';

  @override
  String get playerScreenMinimumCoverPaddingEditorSubtitle =>
      'El margen mínimo alrededor de la portada del álbum en la pantalla del reproductor, en % del ancho de la pantalla.';
  ...
  String get playlistActionsMenuButtonTooltip =>
      'Toque para añadir a lista de reproducción. Toque largo para alternar favorito.';
  ...
  String get bufferDurationSubtitle =>
      'Máximo tiempo, en segundos, que el búfer puede almacenar. Requiere de un reinicio.';

  @override
  String get bufferDisableSizeConstraintsTitle =>
      'No limitar el tamaño del búfer';

  @override
  String get bufferDisableSizeConstraintsSubtitle =>
      'Deshabilita las limitantes del tamaño del búfer (\'Tamaño del Búfer\'). El búfer siempre sera cargado con la duración configurada (\'Duración del Búfer\'), incluso para archivos grandes. Puede causar fallos. Requiere reinicio.';
  ...
  String get bufferSizeSubtitle =>
      'El tamaño máximo para el búfer en MB. Requiere reinicio';
  ...
  String get skipToPreviousTrackButtonTooltip =>
      'Saltar al inicio o a la pista anterior';
  ...
  String get tracksFormerNextUp =>
      'Pistas añadidas a través de \"A Continuación\"';
  ...
  String get playbackOrderLinearButtonTooltip =>
      'Reproduciendo en orden. Toque para mezclar.';
  ...
  String get playbackOrderShuffledButtonTooltip =>
      'Mezclando pistas, toque para reproducir en orden.';
  ...
  String get queueRetryMessage =>
      'Hubo un fallo al restaurar cola. ¿Reintentar?';

  @override
  String get autoloadLastQueueOnStartup =>
      'Restaurar Automáticamente Ultima Cola';

  @override
  String get autoloadLastQueueOnStartupSubtitle =>
      'Al iniciar la aplicación, intentar restaurar la ultima cola reproducida.';
  ...
  String get reportQueueToServerSubtitle =>
      'Mientras esté activo, Finamp enviará la cola del dispositivo al servidor. De momento esta funcionalidad no tiene mucho uso y aumenta el tráfico al servidor.';

  @override
  String get periodicPlaybackSessionUpdateFrequency =>
      'Frecuencia para actualizar la sesión de reproducción';

  @override
  String get periodicPlaybackSessionUpdateFrequencySubtitle =>
      'Cada cuantos segundo enviar el estado de la reproducción al servidor. Este tiene que ser menor que 5 minutos (300 segundos) para evitar que la sesión se acabe.';

  @override
  String get periodicPlaybackSessionUpdateFrequencyDetails =>
      'Si el servidor de Jellyfin no ha recibido no ha recibido ninguna actualización de estado del cliente en los últimos 5 minutos, este asume que la reproducción ha acabado. Esto significa que para canciones más largas de 5 minutos, la reproducción se puede dar como acabada, lo cual empeoraría la información sobra la calidad de reproducción.';
  ...
  String get shuffleAlbumsToNextUp =>
      'Mezclar Álbumes al final de \"A Continuación\"';
  ...
  String get swipeInsertQueueNextSubtitle =>
      'Permite insertar una canción como próxima en ser reproducida de la cola cuando se desliza a un lado en la lista de reproducción, en lugar de añadirla al final.';

  @override
  String get swipeLeftToRightAction => 'Acción de deslizar a la derecha';

  @override
  String get swipeLeftToRightActionSubtitle =>
      'Acción activada al deslizar una pista de la lista de izquierda a derecha.';

  @override
  String get swipeRightToLeftAction => 'Acción de deslizar a la izquierda';

  @override
  String get swipeRightToLeftActionSubtitle =>
      'Acción activada al deslizar una pista de la lista de derecha a izquierda.';

  @override
  String get startInstantMixForIndividualTracksSwitchTitle =>
      'Iniciar Mixes Instantáneos para Pistas Individuales';

  @override
  String get startInstantMixForIndividualTracksSwitchSubtitle =>
      'Al habilitarlo, tocar en una pista en la pestaña de canciones comenzara un mix instantáneo de esa pista en lugar de reproducir una sola pista.';
  ...
  String get repairDownloads =>
      'Reparar problemas con los archivos descargados o metadatos.';
  ...
  String get onlyShowFullyDownloaded =>
      'Mostrar solo álbumes completamente descargados';

  @override
  String get filesystemFull =>
      'El resto de descargas pendientes no han podido ser completadas. El almacenamiento está completo.';

  @override
  String get connectionInterrupted =>
      'Conexión interrumpida, pausando las descargas.';

  @override
  String get connectionInterruptedBackground =>
      'La conexión ha sido interrumpida mientras se continuaban de fondo las descargas. Esto puede haber sido causado por configuraciones del sistema.';

  @override
  String get connectionInterruptedBackgroundAndroid =>
      'La conexión ha sido interrumpida mientras se continuaban de fondo las descargas. Esto puede haber sido causado por tener activado \'Comenzar Modo-de-Baja Prioridad mientras está Pausado\' en la configuración del sistema.';
  ...
  String get runRepairWarning =>
      'El servidor no pudo ser contactado para finalizar la migración de descargas. Por favor ejecute \'Reparar Descargas\' desde la pantalla de descargas tan pronto como este en linea.';
  ...
  String get showNullLibraryItemsTitle =>
      'Mostrar multimedia de una Biblioteca Desconocida.';

  @override
  String get showNullLibraryItemsSubtitle =>
      'Alguna multimedia se puede descargar desde una biblioteca desconocida. Desactive para ocultarla fuera de su colección original.';
  ...
  String get maxConcurrentDownloadsSubtitle =>
      'Aumentar las descargas concurrentes puede ocasionar que una mayor cantidad de descargas fallen si son demasiado grandes, o puede ocasionar retraso en algunas ocasiones.';
  ...
  String get downloadsWorkersSettingSubtitle =>
      'La cantidad de gestores para sincronizar los metadatos y eliminar descargas. Aumentar los gestores de sincronización y eliminación de descargas puede mejorar la velocidad, especialmente cuando la latencia del servidor es alta, pero también puede producir retraso.';
  ...
  String get syncOnStartupSwitch =>
      'Automáticamente Sincronizar Descargas al Inicio';
  ...
  String get preferQuickSyncSwitchSubtitle =>
      'Al realizar sincronizaciones, algunos elementos usualmente estáticos (como pistas y álbumes) no serán actualizados. La reparación de descargas siempre realizara una sincronización completa.';
  ...
  String get downloadTranscodeEnableTitle =>
      'Habilitar Descargas Transcodificadas';
  ...
  String get downloadBitrateSubtitle =>
      'Una mayor tasa de bits da una mejor calidad de audio a costa de mayor requerimientos de almacenamiento.';
  ...
  String get redownloadcomplete =>
      'Cola de Transcodificaciones a Volver a Descargar.';

  @override
  String get redownloadTitle =>
      'Automáticamente Volver a Descargar Transcodificaciones';

  @override
  String get redownloadSubtitle =>
      'Automáticamente vuelve a descargar pistas que se esperan en una calidad diferente debido a cambios en su colección de origen.';

  @override
  String get defaultDownloadLocationButton =>
      'Seleccionar como ubicación de descarga por defecto  Desactive para elegirla al descargar.';

  @override
  String get fixedGridSizeSwitchTitle =>
      'Utilizar un tamaño fijo para las cuadriculas';

  @override
  String get fixedGridSizeSwitchSubtitle =>
      'El tamaño de las cuadriculas no reaccionara al tamaño de la ventana/pantalla.';
  ...
  String get allowSplitScreenSubtitle =>
      'El reproductor sera mostrado junto a otras ventanas en pantallas más grandes.';
  ...
  String get hideQueueButtonSubtitle =>
      'Oculte el botón de cola en la pantalla del reproductor. Deslice hacia arriba para acceder a la cola.';
  ...
  String get oneLineMarqueeTextButtonSubtitle =>
      'Automáticamente desplaza los títulos de las pistas que sean demasiado largos para mostrar en dos lineas';

  @override
  String get marqueeOrTruncateButton =>
      'Utilizar puntos suspensivos para títulos largos';

  @override
  String get marqueeOrTruncateButtonSubtitle =>
      'Mostrar ... al final de los títulos largos en lugar de desplazar el texto';
  ...
  String get hidePlayerBottomActionsSubtitle =>
      'Oculte los botones de cola y letras en la pantalla del reproductor. Deslice hacia arriba para acceder a la cola, deslice hacia la izquierda (debajo de la cáratula del álbum) para ver la letra si esta disponible.';
  ...
  String get prioritizePlayerCoverSubtitle =>
      'Priorizar mostrar una cáratula de álbum más grande en la pantalla del reproductor. Los controles que no sean esenciales serán ocultados de manera mas agresiva en pantallas pequeñas.';

  @override
  String get suppressPlayerPadding =>
      'Ignorar el margen de los controles del reproductor';

  @override
  String get suppressPlayerPaddingSubtitle =>
      'Completamente minimiza los margenes entre los controles de la pantalla del reproductor cuando la cáratula del álbum no esta en tamaño completo.';
  ...
  String get showArtistChipImage =>
      'Mostrar imágenes del artista junto al nombre del artista';

  @override
  String get showArtistChipImageSubtitle =>
      'Esto afecta las pequeñas vistas previas de los artistas, como en la pantalla del reproductor.';
  ...
  String get addRemoveFromPlaylist =>
      'Añadir / Quitar de Lista de Reproducción';
  ...
  String get trackOfflineFavorites =>
      'Sincronizar el estado de todos los favoritos';

  @override
  String get trackOfflineFavoritesSubtitle =>
      'Esto permite mostrar estados de favoritos mas actualizados cuando se este sin conexión.  No se descarga ningún archivo adicional.';

  @override
  String get allPlaylistsInfoSetting =>
      'Descargar Metadatos de la Lista de Reproducción';

  @override
  String get allPlaylistsInfoSettingSubtitle =>
      'Sincronizar los metadatos de todas las listas de reproducción para mejorar su experiencia al utilizarlas';
  ...
  String get fiveLatestAlbumsSettingSubtitle =>
      'Las descargas serán eliminadas conforme envejezcan.  Bloquee la descarga para prevenir que el álbum sea eliminado.';

  @override
  String get cacheLibraryImagesSettings =>
      'Guardar las imágenes de la biblioteca actual en el caché';

  @override
  String get cacheLibraryImagesSettingsSubtitle =>
      'Todas las carátulas de álbumes, artistas, géneros, y listas de reproducción de la biblioteca activa serán descargadas.';

  @override
  String get showProgressOnNowPlayingBarTitle =>
      'Mostrar el progreso de la pista en el mini reproductor de la aplicación';

  @override
  String get showProgressOnNowPlayingBarSubtitle =>
      'Controla que el mini reproductor de la aplicación / la barra de reproduciendo ahora en la parte inferior de la pantalla de musica funcionen como una barra de progreso.';
  ...
  String get showLyricsTimestampsTitle =>
      'Muestra las marcas de tiempo para las letras sincronizadas';

  @override
  String get showLyricsTimestampsSubtitle =>
      'Controla que las marcas de tiempo sean mostradas en cada linea de las letras en la pantalla de letras, si están disponibles.';

  @override
  String get showStopButtonOnMediaNotificationTitle =>
      'Mostrar el botón de detener en la notificación multimedia';

  @override
  String get showStopButtonOnMediaNotificationSubtitle =>
      'Controla que la notificación multimedia tenga un botón de detener además del botón de pausa. Esto detendrá la reproducción sin abrir la aplicación.';
  ...
  String get showSeekControlsOnMediaNotificationTitle =>
      'Muestra controles de posición en la notificación multimedia';

  @override
  String get showSeekControlsOnMediaNotificationSubtitle =>
      'Controla que la notificación multimedia tenga una barra de progreso interactiva. Esto permitirá cambiar la posición de la reproducción sin abrir la aplicación.';
  ...
  String get lyricsAlignmentSubtitle =>
      'Controla la alineación de las letras en la pantalla de letras.';
  ...
  String get lyricsFontSizeSubtitle =>
      'Controla el tamaño de la fuente para las letras en la pantalla de letras.';

  @override
  String get showLyricsScreenAlbumPreludeTitle =>
      'Muestra la carátula antes de las letras';

  @override
  String get showLyricsScreenAlbumPreludeSubtitle =>
      'Controla que la carátula se muestre encima de las letras antes de desplazarlas.';
  ...
  String get keepScreenOnWhilePluggedIn =>
      'Mantener la Pantalla Encendida solo mientras este enchufado';

  @override
  String get keepScreenOnWhilePluggedInSubtitle =>
      'Ignorar el ajuste de Mantener la Pantalla Encendida si el dispositivo esta desenchufado';
  ...
  String get showFeatureChipsToggleSubtitle =>
      'Mostrar información avanzada de la pista como el códec, tasa de bits y más en la pantalla del reproductor.';
  ...
  String get showCoversOnAlbumScreenTitle =>
      'Mostrar Arte de Álbumes en las Canciones';

  @override
  String get showCoversOnAlbumScreenSubtitle =>
      'Mostrar carátulas de álbumes por cada pista independientemente de la pantalla del álbum.';
  ...
  String get emptyTopTracksList =>
      'No has escuchado a ninguna pista de este artista aun.';
  ...
  String get emptyFilteredListSubtitle =>
      'Ningún elemento coincide con el filtro. Intente desactivar los filtros o cambiar el termino de búsqueda.';
  ...
  String get resetSettingsPromptGlobal =>
      '¿Esta seguro que quiere restaurar TODOS los ajustes a sus valores predeterminados?';
  ...
  String get resetSettingsPromptLocal =>
      '¿Quieres restaurar estos ajustes a sus valores predeterminados?';
  ...
  String get allowDeleteFromServerTitle =>
      'Permitir la eliminación del servidor';

  @override
  String get allowDeleteFromServerSubtitle =>
      'Habilita y deshabilita la opción de eliminar de forma permanente una pista del sistema de archivos del servidor cuando sea posible.';
  ...
  String deleteFromTargetDialogText(
    ...
    String _temp1 = intl.Intl.selectLogic(
      ...
      {
        'canDelete':
            ' Esto también eliminara este elemento de este Dispositivo.',
        'cantDelete':
            ' Este elemento se mantendrá en este dispositivo hasta la siguiente sincronización.',
        'notDownloaded': '',
        'other': '',
      },
    );
    String _temp2 = intl.Intl.selectLogic(
      device,
      {
        ...
        'server':
            'el sistema de archivos del servidor y la biblioteca.$_temp1\nEsta acción no se puede revertir',
        'other': '',
      },
    );
  ...
  String get downloadSizeWarningCutoff =>
      'Umbral de Advertencia para Descargas';

  @override
  String get downloadSizeWarningCutoffSubtitle =>
      'Un mensaje de advertencia sera mostrado al descargar más pistas de las especificadas a la vez.';
  ...
  String get showAlbumReleaseDateOnPlayerScreenTitle =>
      'Mostrar Fecha de Lanzamiento de un Álbum en la Pantalla del Reproductor';

  @override
  String get showAlbumReleaseDateOnPlayerScreenSubtitle =>
      'Muestra la fecha de lanzamiento de un álbum en la pantalla del reproductor, después del nombre del álbum.';
  ...
  String get releaseDateFormatSubtitle =>
      'Controla el formato en el que todas las fechas de lanzamiento son mostradas en la aplicación.';
  ...
  String get librarySelectError =>
      'Error al cargar las librerías disponibles para el usuario';

  @override
  String get autoOfflineOptionOff => 'Desactivado';
