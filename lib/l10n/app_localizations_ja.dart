...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get loginFlowQuickConnectInstructions =>
      'Jellyfinアプリまたはウェブサイトを開き、ユーザーアイコンをクリックして「Quick Connect」を選択してください。';

  @override
  String get loginFlowQuickConnectDisabled =>
      'このサーバーでは、Quick Connect が無効になっています。';
  ...
  String get startMixNoTracksGenre =>
      'ミックスを開始する前に、ジャンルを長押ししてミックスビルダーに追加または削除してください';
  ...
  String deleteDownloadsPrompt(String itemName, String itemType) {
    ...
    return 'この装置から、$_temp0 「$itemName」を削除してもよろしいですか?';
  }
  ...
  @override
  String get playlistUpdated => 'プレイリスト名を更新しました。';
  ...
  String get customLocationsBuggy =>
      'カスタムの場所は、非常にバグが多くなるかも知れないので 、ほとんどの場合お勧めません。ＯＳ制限 ので 、「Music」ディレクトリの仲に場所は、ジャケット画像をセーブのが止めされる。';
  ...
  @override
  String get removeFromPlaylistTooltip => 'このプレイリストから外す';

  @override
  String get removeFromPlaylistTitle => 'このプレイリストから外す';
  ...
  @override
  String get downloadItem => 'ダウンロードする';
  ...
  @override
  String get downloadSettings => 'ダウンロード';
  ...
  @override
  String get releaseDateFormatMonthYear => '月と年';
