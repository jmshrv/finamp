...
class AppLocalizationsCs extends AppLocalizations {
  ...
  String get startupErrorTitle =>
      'Při spouštění aplikace se něco nepovedlo!\nZa to se omlouváme…';

  @override
  String get startupErrorCallToAction =>
      'Vytvořte prosím problém na github.com/jmshrv/finamp i s protokoly(!) (použijte tlačítko níže) a snímkem této stránky, abychom chybu mohli opravit co nejrychleji to bude možné.';

  @override
  String get startupErrorWorkaround =>
      'Jako řešení můžete vymazat data aplikace a resetovat ji. Mějte na paměti, že v tomto případě budou odstraněna všechna vaše nastavení a stažené soubory.';
  ...
  String loginFlowWelcomeHeading(String styledName) {
    return 'Vítejte v aplikaci $styledName';
  }
  ...
  @override
  String get appearsOnAlbums => 'Také na';
  ...
  @override
  String get noGenres => 'Žádné žánry';
  ...
  @override
  String get onlineMode => 'Režim online';
  ...
  @override
  String get albumArtists => 'Umělci alba';

  @override
  String get performingArtists => 'Účinkující umělci';
  ...
  @override
  String get premiereDate => 'Datum vydání';
  ...
  @override
  String get libraryDownloads => 'Stahování z knihovny';
  ...
  @override
  String get editPlaylistNameTooltip => 'Upravit seznam skladeb';

  @override
  String get editPlaylistNameTitle => 'Upravit seznam skladeb';
  ...
  @override
  String get playlistUpdated => 'Název seznamu skladeb upraven.';
  ...
  @override
  String get exportLogs => 'Uložit protokoly';
  ...
  @override
  String get playbackReporting => 'Hlášení přehrávání';
  ...
  String get bitrateSubtitle =>
      'Vyšší datový tok poskytuje vyšší kvalitu zvuku, ale zvýší využití internetu. Neplatí pro bezztrátové kodeky, např. FLAC';
  ...
  String get autoSwitchItemCurationTypeTitle =>
      'Automaticky přepnout typ kurátorství položek';

  @override
  String get autoSwitchItemCurationTypeSubtitle =>
      'Sekce položek na obrazovkách umělců a žánrů se automaticky přepnou na jiný typ kurátorství, pokud nejsou dostupné žádné položky (např. žádné oblíbené u konkrétního umělce).';

  @override
  String get showArtistsTracksSection => 'Zobrazit sekci skladeb';

  @override
  String get showArtistsTracksSectionSubtitle =>
      'Zda zobrazit sekci s až pěti skladbami. Můžete si vybírat mezi nejpřehrávanějšími, oblíbenými,náhodnými, nejnovějšími vydáními a nedávno přidanými skladbami.';
  ...
  @override
  String get stopAndClearQueue => 'Zastavit přehrávání a vymazat frontu';
  ...
  String playingFromType(String source) {
    String _temp0 = intl.Intl.selectLogic(
      source,
      {
        ...
        'remoteClient': 'vzdáleného zařízení',
        'other': '',
      },
    );
  ...
  String get reportQueueToServerSubtitle =>
      'Pokud je tato možnost povolena, odešle Finamp aktuální frontu na server. Tato funkce může zlepšit vzdálené ovládání a umožnit serverové obnovení fronty. Povoleno vždy, pokud je povolena možnost „Přehrát na“.';
  ...
  @override
  String get playOnStaleDelay => 'Vypršení relace „Přehrát na“';

  @override
  String get playOnStaleDelaySubtitle =>
      'Jak dlouho po obdržení příkazu bude relace „Přehrát na“ považována za aktivní. Když je považována za aktivní, je přehrávání hlášeno častěji, což může vést ke zvýšené spotřebě dat.';

  @override
  String get enablePlayonTitle => 'Povolit podporu „Přehrát na“';

  @override
  String get enablePlayonSubtitle =>
      'Povolí funkci „Přehrát na“ služby Jellyfin (vzdálené ovládání aplikace Finamp z jiného klienta). Zakažte, pokud vaše reverzní proxy nebo server nepodporuje websockety.';

  @override
  String get playOnReconnectionDelay =>
      'Zpoždění opětovného spojení relace „Přehrát na“';

  @override
  String get playOnReconnectionDelaySubtitle =>
      'Ovládá zpoždění mezi pokusy o opětovné připojení k websocketu PlayOn po jeho odpojení (v sekundách). Nižší zpoždění zvýší využití dat.';

  @override
  String get topTracks => 'Nejlepší skladby';

  @override
  String get topAlbums => 'Nejlepší alba';

  @override
  String get topArtists => 'Nejlepší umělci';
  ...
  @override
  String get latestTracks => 'Nejnovější skladby';

  @override
  String get latestAlbums => 'Nejnovější alba';

  @override
  String get latestArtists => 'Nejnovější umělci';
  ...
  @override
  String get favoriteTracks => 'Oblíbené skladby';

  @override
  String get favoriteAlbums => 'Oblíbená alba';

  @override
  String get favoriteArtists => 'Oblíbení umělci';

  @override
  String get randomTracks => 'Skladby (náhodný výběr)';

  @override
  String get randomAlbums => 'Alba (náhodný výběr)';

  @override
  String get randomArtists => 'Umělci (náhodný výběr)';

  @override
  String get mostPlayed => 'Nejpřehrávanější';

  @override
  String get randomFavoritesFirst => 'Náhodné (nejdříve oblíbené)';
  ...
  @override
  String get latestReleases => 'Nejnovější vydání';

  @override
  String get itemSectionsOrder => 'Pořadí sekcí položek';

  @override
  String get unknown => 'Unknown';

  @override
  String get itemSectionsOrderSubtitle => 'Ovládá pořadí sekcí položek.';

  @override
  String get genreItemSectionFilterChipOrderTitle =>
      'Pořadí filtrů sekcí položek';

  @override
  String get genreItemSectionFilterChipOrderSubtitle =>
      'Ovládá pořadí dostupných filtrů u sekcí položek.';

  @override
  String get artistItemSectionFilterChipOrderTitle =>
      'Pořadí filtrů sekce skladeb';

  @override
  String get artistItemSectionFilterChipOrderSubtitle =>
      'Ovládá pořadí dostupných filtrů u sekce skladeb.';

  @override
  String get genreFilterArtistScreens => 'Filtrovat obrazovky umělců';

  @override
  String get genreFilterArtistScreensSubtitle =>
      'Obrazovky umělců (přistupované přes žánry) zobrazí pouze skladby a alba, která odpovídají žánru, který si aktuálně procházíte. (Vždy je možné ručně odebrat filtr žánrů pro zobrazení všech skladeb a alb.)';
  ...
  @override
  String get genreListsInheritSorting => 'Kompletní dědění řazení seznamů';

  @override
  String get genreListsInheritSortingSubtitle =>
      'Seznamy „Zobrazit vše“ budou dědit řazení a filtrování z obrazovky Žánry. Pokud je zakázáno, budou místo toho použita nastavení z odpovídající karty knihovny. Klepnutím na Počty v horní části obrazovky Žánry vždy otevřete kompletní seznam s nastavením řazení z karty knihovny.';

  @override
  String get curatedItemsMostPlayedOfflineTooltip =>
      'Nedostupné v režimu offline.';
  ...
  String get playbackReportingSettingsTitle =>
      'Hlášení přehrávání a „Přehrát na“';
  ...
  @override
  String get swipeLeftToRightAction => 'Akce při přejetí doprava';

  @override
  String get swipeLeftToRightActionSubtitle =>
      'Akce vyvolaná při přejetí po skladbě v seznamu zleva doprava.';

  @override
  String get swipeRightToLeftAction => 'Akce při přejetí doleva';

  @override
  String get swipeRightToLeftActionSubtitle =>
      'Akce vyvolaná při přejetí po skladbě v seznamu zprava doleva.';
  ...
  String finampCollectionNames(String itemType) {
    String _temp0 = intl.Intl.selectLogic(
      itemType,
      {
        ...
        'collectionWithLibraryFilter': 'Sbírka s filtrem knihovny',
        'other': '$itemType',
      },
    );
    return '$_temp0';
  ...
  @override
  String get transcodingStreamingFormatTitle => 'Vyberte formát překódování';

  @override
  String get transcodingStreamingFormatSubtitle =>
      'Vyberte formát, který se má použít při streamování překódovaného zvuku. Skladby, které jsou již ve frontě, nebudou ovlivněny.';
  ...
  @override
  String get lyricsScreenButtonTitle => 'Text';
  ...
  String get showStopButtonOnMediaNotificationSubtitle =>
      'Určuje, zda má oznámení médií mít tlačítko pro zastavení. To umožňuje zastavit přehrávání bez otevření aplikace.';

  @override
  String get showShuffleButtonOnMediaNotificationTitle =>
      'Zobrazit tlačítko náhodného přehrávání v oznámení médií';

  @override
  String get showShuffleButtonOnMediaNotificationSubtitle =>
      'Určuje, zda má oznámení médií mít tlačítko pro náhodné přehrávání. To umožňuje zamíchat / zrušit zamíchání přehrávání bez otevření aplikace.';

  @override
  String get showFavoriteButtonOnMediaNotificationTitle =>
      'Zobrazit tlačítko Oblíbené v oznámení médií';

  @override
  String get showFavoriteButtonOnMediaNotificationSubtitle =>
      'Určuje, zda má oznámení médií mít tlačítko Oblíbené. To umožňuje označit aktuální skladbu jako oblíbenou bez otevření aplikace.';

  @override
  String get showSeekControlsOnMediaNotificationTitle =>
      'Umožnit ovládání posunu v oznámení médií';
  ...
  @override
  String get artistScreen => 'Obrazovka umělce';
  ...
  @override
  String get genreScreen => 'Obrazovka žánrů';
  ...
  @override
  String get noReleaseDate => 'Žádné datum vydání';
  ...
  @override
  String get autoOfflineOptionOff => 'Zakázáno';

  @override
  String get autoOfflineOptionNetwork => 'Místní síť';

  @override
  String get autoOfflineOptionDisconnected => 'Odpojeno';

  @override
  String get autoOfflineSettingDescription =>
      'Automaticky povolit offline režim\nZakázáno: offline režim nebude automaticky zapnut. Může šetřit baterii.\nMístní síť: zapnout offline režim, když nejste připojeni k Wi-Fi nebo ethernetu.\nOdpojeno: zapnout offline režim, když nejste připojeni k ničemu.\nOffline režim můžete vždy ručně zapnout. Pozastavíte tím automatické akce, dokud režim opět nevypnete';

  @override
  String get autoOfflineSettingTitle => 'Automatický offline režim';
  ...
  String autoOfflineNotification(String state) {
    String _temp0 = intl.Intl.selectLogic(
      state,
      {
        'enabled': 'zapnut',
        'disabled': 'vypnut',
        'other': 'nastavena kvantová pozice',
      },
    );
    return 'Offline režim automaticky $_temp0';
  }
  ...
  String get audioFadeOutDurationSettingSubtitle =>
      'Délka, po kterou se bude postupně snižovat hlasitost zvuku, v milisekundách.';
  ...
  String get audioFadeInDurationSettingSubtitle =>
      'Délka, po kterou se bude postupně zvyšovat hlasitost zvuku, v milisekundách. Nastavte na 0 pro zakázání.';

  @override
  String get outputMenuButtonTitle => 'Výstup';

  @override
  String get outputMenuTitle => 'Změnit výstup';

  @override
  String get outputMenuVolumeSectionTitle => 'Hlasitost';

  @override
  String get outputMenuDevicesSectionTitle => 'Dostupná zařízení';
  ...
  String get desktopShuffleWarning =>
      'Změna náhodného přehrávání není na počítačích v současné době k dispozici.';

  @override
  String get preferHomeNetworkActiveAddressInfoText => 'Aktivní adresa';
  ...
  String get preferHomeNetworkTargetAddressLocalSettingDescription =>
      'Cílová adresa serveru Jellyfin uvnitř vaší domácí sítě';

  @override
  String get preferHomeNetworkEnableSwitchTitle => 'Upřednostňovat domácí síť';

  @override
  String get preferHomeNetworkEnableSwitchDescription =>
      'Zda používat jinou adresu, když jste doma';

  @override
  String get preferHomeNetworkPublicAddressSettingTitle => 'Veřejná adresa';

  @override
  String get preferHomeNetworkPublicAddressSettingDescription =>
      'Primární adresa používaná k připojení k vašemu serveru Jellyfin';

  @override
  String get preferHomeNetworkInfoBox =>
      'Tato funkce vyžaduje oprávnění k poloze (a zapnuté polohové služby) pro přečtení názvu sítě.';

  @override
  String get networkSettingsTitle => 'Síť';

  @override
  String get downloadPaused =>
      'Stahování pozastaveno, protože zařízení není připojeno k síti Wi-Fi';

  @override
  String get missingSchemaError => 'Adresa musí začínat textem http(s)://';

  @override
  String get testConnectionButtonLabel => 'Otestovat obě spojení';
  ...
  String ping(String status) {
    String _temp0 = intl.Intl.selectLogic(
      status,
      {
        'true_true': 'Obě dosažitelná',
        'true_false': 'NEPODAŘILO se dosáhnout místní adresy',
        'false_true': 'NEPODAŘILO se dosáhnout veřejné adresy',
        'false_false': 'NEPODAŘILO se dosáhnout obou',
        'other': 'neznámé',
      },
    );
    return '$_temp0';
  ...
  @override
  String get autoReloadQueueTitle => 'Automaticky znovu načíst frontu';

  @override
  String get autoReloadQueueSubtitle =>
      'Automaticky znovu načíst frontu při změně zdroje (např. povolený offline režim nebo přepnutí adresy serveru). Pokud je zakázáno, Finamp se vás nejprve zeptá.';
  ...
  String autoReloadPrompt(String type) {
    String _temp0 = intl.Intl.selectLogic(
      type,
      {
        ...
        'transcoding': 'nastavení kódování',
        'other': 'nastavení',
      },
    );
    return 'Znovu načíst frontu pro použití nového $_temp0';
  }
  ...
  String autoReloadPromptMissingTracks(int amountUndownloadedTracks) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other: '$amountUndownloadedTracks skladeb',
      few: '$amountUndownloadedTracks skladby',
      one: '1 skladba',
    );
    return '$_temp0 bude odstraněno z fronty, protože nejsou staženy.';
  }

  @override
  String get autoReloadPromptReloadButton => 'Znovu načíst';
}
