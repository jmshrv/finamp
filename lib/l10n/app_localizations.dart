...
abstract class AppLocalizations {
  ...
  /// The title for the error screen that shows when startup fails.
  ///
  /// In en, this message translates to:
  /// **'Something went wrong during app startup!\nSorry about that...'**
  String get startupErrorTitle;

  /// The subtitle / call to action for what to do after encountering a startup error
  ///
  /// In en, this message translates to:
  ...
  /// The subtitle for how to manually recover from a startup error
  ///
  /// In en, this message translates to:
  ...
  /// Gets shown when there are no genres available for an album or artist
  ///
  /// In en, this message translates to:
  /// **'No Genres'**
  String get noGenres;
  ...
  /// No description provided for @performingArtist.
  ///
  /// In en, this message translates to:
  /// **'Performing Artist'**
  String get performingArtist;
  ...
  /// Returns a relative time string based on how long ago something happened. Used for various DateTime values such as Date Last Played and Date Added.
  ///
  /// In en, this message translates to:
  /// **'{type, select, just_now{just now} minutes{{value} min ago} hours{{value} h ago} yesterday{yesterday} days{{value, plural, =1{1 day ago} other{{value} days ago}}} other{value}}'**
  ...
  /// No description provided for @autoSwitchItemCurationTypeTitle.
  ///
  /// In en, this message translates to:
  /// **'Auto-Switch Item Curation Type'**
  String get autoSwitchItemCurationTypeTitle;

  /// No description provided for @autoSwitchItemCurationTypeSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @showArtistsTracksSection.
  ///
  /// In en, this message translates to:
  /// **'Show Tracks Section'**
  String get showArtistsTracksSection;

  /// No description provided for @showArtistsTracksSectionSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// Label for a button on the genre screen that brings you to a list of genre-filtered playlists.
  ///
  /// In en, this message translates to:
  /// **'Browse Playlists'**
  ...
  /// Label for the artist section that shows tracks that were recently added to the library, sorted by the date they were added.
  ///
  /// In en, this message translates to:
  /// **'Recently Added Tracks'**
  String get recentlyAddedTracks;

  /// Label for the genre section that shows albums that were recently added to the library, sorted by the date they were added.
  ///
  /// In en, this message translates to:
  /// **'Recently Added Albums'**
  String get recentlyAddedAlbums;

  /// Label for the genre section that shows artists that were recently added to the library, sorted by the date they were added.
  ///
  /// In en, this message translates to:
  /// **'Recently Added Artists'**
  String get recentlyAddedArtists;

  /// No description provided for @latestTracks.
  ///
  /// In en, this message translates to:
  /// **'Latest Tracks'**
  String get latestTracks;

  /// No description provided for @latestAlbums.
  ///
  /// In en, this message translates to:
  /// **'Latest Albums'**
  String get latestAlbums;

  /// No description provided for @latestArtists.
  ///
  /// In en, this message translates to:
  /// **'Latest Artists'**
  String get latestArtists;

  /// No description provided for @recentlyPlayedTracks.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @randomTracks.
  ///
  /// In en, this message translates to:
  /// **'Tracks (Random Picks)'**
  String get randomTracks;
  ...
  /// No description provided for @randomArtists.
  ///
  /// In en, this message translates to:
  /// **'Artists (Random Picks)'**
  String get randomArtists;
  ...
  /// No description provided for @randomFavoritesFirst.
  ///
  /// In en, this message translates to:
  /// **'Random (Favorites First)'**
  String get randomFavoritesFirst;
  ...
  /// Label for the setting that controls the order of item sections on the screens.
  ///
  /// In en, this message translates to:
  /// **'Item Sections Order'**
  String get itemSectionsOrder;
  ...
  /// Description of the setting that controls the order of item sections on the screens.
  ///
  /// In en, this message translates to:
  /// **'Controls the order of Item Sections.'**
  String get itemSectionsOrderSubtitle;

  /// Label for the setting that controls the order of item sections filter chips.
  ///
  /// In en, this message translates to:
  /// **'Item Sections Filter Order'**
  String get genreItemSectionFilterChipOrderTitle;

  /// Description of the setting that controls the order of item sections filter chips.
  ///
  /// In en, this message translates to:
  /// **'Controls the order of available filters for item sections.'**
  String get genreItemSectionFilterChipOrderSubtitle;

  /// Label for the setting that controls the order of the tracks sections filter chips.
  ///
  /// In en, this message translates to:
  /// **'Tracks Section Filter Order'**
  String get artistItemSectionFilterChipOrderTitle;

  /// Description of the setting that controls the order of the tracks sections filter chips.
  ///
  /// In en, this message translates to:
  /// **'Controls the order of available filters for the tracks section.'**
  String get artistItemSectionFilterChipOrderSubtitle;

  /// Label for the setting that controls if a genreFilter should get applied to ArtistScreens when accessing the ArtistScreens through a Genre.
  ///
  /// In en, this message translates to:
  /// **'Filter Artists'**
  String get genreFilterArtistScreens;

  /// Description of the setting that controls if a genreFilter should get applied to ArtistScreens when accessing the ArtistScreens through a Genre.
  ///
  /// In en, this message translates to:
  ...
  /// Label for the setting that controls if a genreFilter should get applied to PlaylistScreens when accessing the PlaylistScreens through a Genre.
  ///
  /// In en, this message translates to:
  /// **'Filter Playlists'**
  String get genreFilterPlaylistScreens;

  /// Description of the setting that controls if a genreFilter should get applied to PlaylistScreens when accessing the PlaylistScreens through a Genre.
  ///
  /// In en, this message translates to:
  ...
  /// Label for the setting that controls if a See All Genre Lists should inherit the Genre Sorting and Filtering.
  ///
  /// In en, this message translates to:
  /// **'Full Lists Sorting Inheritance'**
  String get genreListsInheritSorting;

  /// Description of the setting that controls if a See All Genre Lists should inherit the Genre Sorting and Filtering.
  ///
  /// In en, this message translates to:
  ...
  /// Tooltip for Most Played on Curated Items in Offline Mode.
  ///
  /// In en, this message translates to:
  /// **'Not available in Offline Mode.'**
  String get curatedItemsMostPlayedOfflineTooltip;

  /// Tooltip for Most Played and Recently Played on Curated Items in Online Mode when not yet listened to any tracks.
  ///
  /// In en, this message translates to:
  /// **'You haven\'t listened to any tracks{itemType, select, artistGenreFilter{ by this artist in this genre} artist{ by this artist} genre{ in this genre} other{}}.'**
  String curatedItemsNotListenedYet(String itemType);

  /// Tooltip for Favorites on Curated Items in Online Mode when no favorites yet.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have any favorites{itemType, select, artistGenreFilter{ for this artist in this genre} artist{ for this artist} genre{ for this genre} other{}}.'**
  String curatedItemsNoFavorites(String itemType);

  /// Message for empty See All lists for a genre.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have any {itemType, select, playlists{playlists} artists{artists} albums{albums} tracks{tracks} other{items}} for this genre.'**
  ...
  /// Tooltip shown when a download button is disabled because of an active genre filter.
  ///
  /// In en, this message translates to:
  /// **'Please remove the genre filter to enable the download actions.'**
  String get downloadButtonDisabledGenreFilterTooltip;

  /// Message shown when the user tries to apply a genre filter to an album.
  ///
  /// In en, this message translates to:
  /// **'Genre Filters are not available for Albums.'**
  String get genreFilterNotAvailableForAlbums;

  /// Message shown when a genre filter or open-genre action fails because the genre item could not be found.
  ///
  /// In en, this message translates to:
  /// **'The genre could not be found.{additionalInfo, select, offline{ It might not be downloaded or may belong to a different library.} other{ It may belong to a different library.}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{itemType, select, favorites{Favorites} allPlaylists{All Playlists} fiveLatestAlbums{5 Latest Albums} allPlaylistsMetadata{Playlist Metadata} collectionWithLibraryFilter{Collection with Library Filter} other{{itemType}} }'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{size} {codec}{bitrate, select, null{} other{ @ {bitrate} Transcoded}}{location, select, null{} other{ ({location})}}'**
  String downloadInfo(
  ...
  ///
  /// In en, this message translates to:
  /// **'{size}{codec, select, ORIGINAL{} other{ as {codec} @ {bitrate}}}{location, select, null{} other{ ({location})}}'**
  ...
  /// Title for the setting that controls if the media notification has a stop button.
  ///
  /// In en, this message translates to:
  /// **'Show Stop Button on Media Notification'**
  String get showStopButtonOnMediaNotificationTitle;

  /// Subtitle for the setting that controls if the media notification has a stop button.
  ///
  /// In en, this message translates to:
  ...
  /// Title for the setting that controls if the media notification has a shuffle button.
  ///
  /// In en, this message translates to:
  /// **'Show Shuffle Button on Media Notification'**
  String get showShuffleButtonOnMediaNotificationTitle;

  /// Subtitle for the setting that controls if the media notification has a shuffle button.
  ///
  /// In en, this message translates to:
  ...
  /// Title for the setting that controls if the media notification has a favorite button.
  ///
  /// In en, this message translates to:
  /// **'Show Favorite Button on Media Notification'**
  String get showFavoriteButtonOnMediaNotificationTitle;

  /// Subtitle for the setting that controls if the media notification has a favorite button.
  ///
  /// In en, this message translates to:
  ...
  /// Name for the view/screen that shows artists
  ///
  /// In en, this message translates to:
  /// **'Artist Screen'**
  String get artistScreen;

  /// Title for the setting that controls if taps on genre chips should apply a genre filter to the current screen or should redirect to the GenreScreen.
  ///
  /// In en, this message translates to:
  /// **'Apply Filter On Genre Tap'**
  String get applyFilterOnGenreChipTapTitle;

  /// Subtitle for the setting that controls if taps on genres should apply a genre filter to the current screen or should redirect to the GenreScreen.
  ///
  /// In en, this message translates to:
  ...
  /// A snackbar that is shown to the user if a genre filter was applied due to their selected settings
  ///
  /// In en, this message translates to:
  /// **'Applied genre filter'**
  String get applyFilterOnGenreChipTapPrompt;

  /// The button for the snackbar that is shown to the user if a genre filter was applied due to their selected settings
  ///
  /// In en, this message translates to:
  /// **'Open Genre'**
  String get applyFilterOnGenreChipTapPromptButton;

  /// Name for the view/screen that shows genres
  ///
  /// In en, this message translates to:
  /// **'Genre Screen'**
  String get genreScreen;
  ...
  /// Placeholder text if an item has no release date set.
  ///
  /// In en, this message translates to:
  /// **'No Release Date'**
  String get noReleaseDate;

  /// Placeholder text if an item has no dateAdded set.
  ///
  /// In en, this message translates to:
  /// **'No Date Added'**
  String get noDateAdded;

  /// Placeholder text if an item has no lastPlayedDate set.
  ///
  /// In en, this message translates to:
  /// **'Not played yet'**
  String get noDateLastPlayed;
  ...
  /// This is shown when the autoOffline feature is set to "local Network", this means offline mode will be automatically enabled when no wifi or ethernet connection is active
  ///
  /// In en, this message translates to:
  /// **'Local Network'**
  ...
  /// Title for the audio fade-out duration setting.
  ///
  /// In en, this message translates to:
  /// **'Audio fade-out duration'**
  String get audioFadeOutDurationSettingTitle;

  /// Subtitle for the audio fade-out duration setting. Set to 0 to disable fade-out.
  ///
  /// In en, this message translates to:
  ...
  /// Shows the active address inside the network settings screen so the user can see if this feature works
  ///
  /// In en, this message translates to:
  /// **'Active Address'**
  String get preferHomeNetworkActiveAddressInfoText;

  /// No description provided for @preferHomeNetworkTargetAddressLocalSettingTitle.
  ///
  /// In en, this message translates to:
  /// **'Home Network Address'**
  String get preferHomeNetworkTargetAddressLocalSettingTitle;

  /// No description provided for @preferHomeNetworkTargetAddressLocalSettingDescription.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @preferHomeNetworkEnableSwitchTitle.
  ///
  /// In en, this message translates to:
  /// **'Prefer Home Network'**
  String get preferHomeNetworkEnableSwitchTitle;

  /// No description provided for @preferHomeNetworkEnableSwitchDescription.
  ///
  /// In en, this message translates to:
  /// **'Whether or not to use a different address when you are at home'**
  String get preferHomeNetworkEnableSwitchDescription;

  /// No description provided for @preferHomeNetworkPublicAddressSettingTitle.
  ///
  /// In en, this message translates to:
  /// **'Public Address'**
  String get preferHomeNetworkPublicAddressSettingTitle;

  /// No description provided for @preferHomeNetworkPublicAddressSettingDescription.
  ///
  /// In en, this message translates to:
  /// **'The primary address used to connect to your Jellyfin server'**
  String get preferHomeNetworkPublicAddressSettingDescription;

  /// This is only shown on ios and android since desktop doesnt require location permissions
  ///
  /// In en, this message translates to:
  ...
  /// Title for the network settings screen
  ///
  /// In en, this message translates to:
  /// **'Network'**
  String get networkSettingsTitle;

  /// Gets shown in the snackbar if loosing wifi connection while downloads are running and the 'requireWifiForDownloads' is enabled
  ///
  /// In en, this message translates to:
  /// **'Downloading paused because device is not connected to WiFi'**
  String get downloadPaused;

  /// Snackbar message when the user changes their home/public address but it doesn't start with http
  ///
  /// In en, this message translates to:
  /// **'Url needs to start with http(s)://'**
  String get missingSchemaError;

  /// Button to test the public and local url inside the network settings tab
  ///
  /// In en, this message translates to:
  /// **'Test both connections'**
  String get testConnectionButtonLabel;

  /// Gets shown in the Snackbar when using the Test Connection Button inside the Network Settings. true means reachable, false means unreachable. the first value is for the public address, the second value is fot the home address.
  ///
  /// In en, this message translates to:
  /// **'{status, select, true_true{Both reachable} true_false{FAILED to reach local address} false_true{FAILED to reach public address} false_false{FAILED to reach both} other{unknown}}'**
  String ping(String status);

  /// Title for the setting that controls if the queue is automatically reloaded when the source changes
  ///
  /// In en, this message translates to:
  /// **'Automatically Reload Queue'**
  String get autoReloadQueueTitle;

  /// Subtitle for the setting that controls if the queue is automatically reloaded when the source changes
  ///
  /// In en, this message translates to:
  ...
  /// Prompt shown when the queue needs to be reloaded after changing network settings
  ///
  /// In en, this message translates to:
  /// **'Reload queue to apply new {type, select, network{network settings} transcoding{transcoding settings} other{settings}}'**
  String autoReloadPrompt(String type);

  /// Additional prompt text shown when the queue needs to be reloaded after changing network settings and some undownloaded tracks are in the queue
  ///
  /// In en, this message translates to:
  /// **'{amountUndownloadedTracks, plural, =1{1 track} other{{amountUndownloadedTracks} tracks}} will be removed from the queue because they aren\'t downloaded.'**
  String autoReloadPromptMissingTracks(int amountUndownloadedTracks);

  /// Button title for reloading the queue after network settings change
  ///
  /// In en, this message translates to:
  /// **'Reload'**
  String get autoReloadPromptReloadButton;
}
