...
extension FinampSetters on FinampSettingsHelper {
  ...
  static void setDownloadLocations(List<DownloadLocation> newDownloadLocations) {
    FinampSettings finampSettingsTemp = FinampSettingsHelper.finampSettings;
...
extension FinampSettingsProviderSelectors on StreamProvider<FinampSettings> {
  ...
  ProviderListenable<List<DownloadLocation>> get downloadLocations =>
      finampSettingsProvider.select((value) => value.requireValue.downloadLocations);
  ...
  ProviderListenable<bool> get onlyShowFavourites =>
      finampSettingsProvider.select((value) => value.requireValue.onlyShowFavourites);
  ProviderListenable<SortBy> get sortBy => finampSettingsProvider.select((value) => value.requireValue.sortBy);
  ProviderListenable<SortOrder> get sortOrder => finampSettingsProvider.select((value) => value.requireValue.sortOrder);
  ...
  ProviderListenable<int> get sleepTimerSeconds =>
      finampSettingsProvider.select((value) => value.requireValue.sleepTimerSeconds);
  ...
  ProviderListenable<bool> get showArtistsTopTracks =>
      finampSettingsProvider.select((value) => value.requireValue.showArtistsTopTracks);
  ...
  ProviderListenable<ArtistType> get artistListType =>
      finampSettingsProvider.select((value) => value.requireValue.artistListType);
