...
class MusicPlayerBackgroundTask extends BaseAudioHandler {
  ...
  Duration get sleepTimerRemaining {
    if (_sleepTimer.value == null) {
      ...
      return _sleepTimerStartTime.add(_sleepTimerDuration).difference(DateTime.now());
    }
  }
        ...
        MediaControl.custom(
          ...
          label: isFavorite
              ? (GlobalSnackbar.materialAppScaffoldKey.currentContext != null
                  ? AppLocalizations.of(GlobalSnackbar.materialAppScaffoldKey.currentContext!)!.removeFavourite
                  : "Remove favorite")
              : (GlobalSnackbar.materialAppScaffoldKey.currentContext != null
                  ? AppLocalizations.of(GlobalSnackbar.materialAppScaffoldKey.currentContext!)!.addFavourite
                  : "Add favorite"),
        ),
