                                      ...
                                      Stack(
                                        ...
                                        children: [
                                          AlbumImage(
                                            ...
                                            itemsToPrecache:
                                                queueService.getNextXTracksInQueue(3).map((e) {
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: FavoriteButton(
                                                        item: currentTrackBaseItem,
                                                        onToggle: (isFavorite) {
                                                          currentTrackBaseItem!.userData!.isFavorite = isFavorite;
                                                          snapshot.data!.mediaItem?.extras!["itemJson"] = currentTrackBaseItem.toJson();
                                                        },
                                                      ),
                                                    ),
                                                  ],
