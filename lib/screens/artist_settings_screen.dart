      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SwitchListTile.adaptive(
            ...
            subtitle: Text(AppLocalizations.of(context)!.showArtistsTracksSectionSubtitle),
              ...
              ReorderableListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ReorderableDelayedDragStartListener(
                      ...
                      index: index,
                      child: ListTile(
                        title: Text(FinampSettingsHelper.finampSettings.artistItemSectionFilterChipOrder[index]
                  ...
                  onReorder: (oldIndex, newIndex) {
                    setState(() {
                      if (oldIndex < newIndex) newIndex -= 1;
                      final currentOrder =
                          List.of(FinampSettingsHelper.finampSettings.artistItemSectionFilterChipOrder);
                      final movedItem = currentOrder.removeAt(oldIndex);
                      currentOrder.insert(newIndex, movedItem);
